...
function WhyChooseUs() {
  ...
  return (
    <div className="text-black mx-auto container">
      ...
      <div className="overflow-x-hidden pb-25 ">
        <Swiper
          className="overflow-visible! [&_.swiper-pagination]:-bottom-19!"
          modules={[Pagination]}
          slidesPerView={2}
          spaceBetween={24}
          pagination={{
        ...
        <div class="flex items-center gap-4 w-full max-w-150 mx-auto">
          ...
          <div class="flex-1 h-0.5  relative bg-black/10">
            <span 
              class="absolute left-0 top-0  bg-[#0095FF] rounded-[100%] h-0.75"
